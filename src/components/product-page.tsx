...
export function ProductPage({ product }: { product: Product }) {
  ...
  const sibling = siblingProduct(product);
  ...
  return (
    <SiteShell>
      ...
      {productReviews.length > 0 && (
        <section id="reviews" className="border-t border-border scroll-mt-28">
          <div className="container-max section-pad py-16">
            <div className="mb-6 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-muted">
                  {product.rating} · {product.reviewCount} beoordelingen voor {product.subcat}
                </p>
              </div>
      ...
      {related.length > 0 && (
        <section className="border-t border-border bg-bg-elevated">
          <div className="container-max section-pad py-16">
            <h2 className="text-2xl font-extrabold tracking-tight">Andere sterkte / vorm</h2>
            <p className="mt-1 mb-6 text-sm text-muted">
              Zelfde stof in een andere vorm, plus andere GLP-1 opties om te vergelijken.
            </p>
