...
- **Home: 8/10** — Weekdeal, bestseller, ratings, H1 + CTA above the fold, grid ordered beginner-first. Category hashes now filter and scroll to `#producten`.
- **PDP: 8/10** — Buy box shows duration, €/week, shipping, retour, labgetest, syringe extras, sibling form, and short reviews.
- **Cart: 9/10** — Opens on add, persists, line qty, totals, stack + code, free-ship bar, error toasts, invalid codes no longer wipe VOLT10.
- **Mobile: 8/10** — Sticky “Kopen” uses the stepper qty, sits above the cookie bar, and has a cart badge.
- **Trust: 8/10** — Rating links to reviews, 30-dagen retour and labgetest sit next to buy, cutoff copy is honest after 23:00.
...
- File: /Users/mpp/Desktop/VOLT landing page/src/components/cart-store.ts:126
